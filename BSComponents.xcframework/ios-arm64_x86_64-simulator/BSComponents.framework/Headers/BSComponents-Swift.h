...
#ifndef BSCOMPONENTS_SWIFT_H
#define BSCOMPONENTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BSComponents",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12BSComponents26BSCollectionViewDataSource")
@interface BSCollectionViewDataSource : NSObject <UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)collectionContentHeightDidChange;
...
SWIFT_CLASS("_TtC12BSComponents30BSPageViewControllerDataSource")
@interface BSPageViewControllerDataSource : NSObject
...
SWIFT_CLASS("_TtC12BSComponents39BSPageViewControllerDataSourceWithIndex")
@interface BSPageViewControllerDataSourceWithIndex : BSPageViewControllerDataSource
...
SWIFT_CLASS("_TtC12BSComponents21BSPagerViewDataSource")
@interface BSPagerViewDataSource : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC12BSComponents22BSPickerViewDataSource")
@interface BSPickerViewDataSource : NSObject <UIPickerViewDataSource, UIPickerViewDelegate>
...
/// intended to work as extendedDataProviderDelegate, displays tableview native section/row animations on data changes
SWIFT_CLASS("_TtC12BSComponents29BSTableViewDataSourceExtended")
@interface BSTableViewDataSourceExtended : BSTableViewDataSource
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface NSFetchedResultsController<ResultType> (SWIFT_EXTENSION(BSComponents))
@property (nonatomic, readonly) NSInteger sectionsCount;
- (id _Nullable)sectionModelWithSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)elementsCountIn:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (id _Nullable)elementModelAt:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_PROTOCOL("_TtP12BSComponents22PagingableViewProtocol_")
